      ...
      <div class="episode-info">
        ...
        ${link ? `
          <div style="display:flex;align-items:center;gap:12px;margin-top:8px;flex-wrap:wrap;">
            <button class="ep-play-btn" onclick="openWithIntent('${link}')">
              ▶ Play
            </button>
            ${quality ? `<span style="font-size:12px;font-weight:700;color:#ccc;font-family:Inter;padding-top: 2px;">${quality}</span>` : ''}
            ${size    ? `<span style="font-size:12px;color:#ccc;font-weight:700;font-family:Inter;padding-top: 2px;">${size}</span>` : ''}
          </div>
        ` : ''}
      </div>
    `;
